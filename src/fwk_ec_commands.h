...
#ifndef __FWK_EC_COMMANDS_H
#define __FWK_EC_COMMANDS_H
 ...
 */
#define EC_CMD_GET_FWK_BOARD_INFO	0x011F
/*
 * Write info into Cros Board Info on EEPROM. Write fails if the board has
 * hardware write-protect enabled.
 */
#define EC_CMD_SET_FWK_BOARD_INFO	0x0120
